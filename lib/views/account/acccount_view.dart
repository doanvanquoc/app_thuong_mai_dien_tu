import 'package:app_thuong_mai_dien_tu/views/account/Editpass_view.dart';
      ...
      body: ListView(
        children: [
          ...
          ItemAccount(
            ...
            iconLeft: const Icon(Icons.person_outline, size: 35,),
            iconRight: const Icon(Icons.chevron_right, size: 35,),
            onTap: (){
              Navigator.push(
                context,
          ...
          ItemAccount(
            title: 'Đổi mật khẩu',
            iconLeft: const Icon(Icons.lock_outlined, size: 35,),
            iconRight: const Icon(Icons.chevron_right, size: 35,),
            onTap: (){
              Navigator.push(
                context,
          ...
          ItemAccount(
            title: 'Địa chỉ',
            iconLeft: const Icon(Icons.location_on_outlined, size: 35,),
            iconRight: const Icon(Icons.chevron_right, size: 35,),
            onTap: (){},
          ),
          const SizedBox(height: 35,),
          ItemAccount(
            title: 'Thông báo',
            iconLeft: const Icon(Icons.notifications_outlined, size: 35,),
            iconRight: const Icon(Icons.chevron_right, size: 35,),
            onTap: (){},
          ),
          const SizedBox(height: 35,),
          ItemAccount(
            title: 'Đăng xuất',
            colorr: Colors.red,
            iconLeft: const Icon(Icons.logout, size: 35, color: Colors.red,),
            iconRight: null,
            onTap: (){
