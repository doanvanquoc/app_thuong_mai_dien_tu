...
class HomeAllNewProduct extends StatefulWidget {
  const HomeAllNewProduct(
      {super.key, required this.companies, required this.user});
  @override
  State<HomeAllNewProduct> createState() => _HomeAllNewProductState();
  final List<Company> companies;
  final User user;
}

class _HomeAllNewProductState extends State<HomeAllNewProduct> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sản phẩm mới nhất'),
                  ...
                  return GestureDetector(
                    onTap: () async {
                      ...
                      List<Product> products = index == 0
                          ? await ProductPresenter.instance.getLatestProduct()
                ...
                itemBuilder: (context, index) => ProductItem(
                  ...
                  onTap: () async {
                    ...
                    await CartPresenter.instance.addToCart(
                        ...
                        productID: newProducts[index].productID,
                        quantity: 1);
